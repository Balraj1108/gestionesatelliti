		  ...
		  <div class="container">
				...
				<div class="alert alert-info alert-dismissible fade show d-none" role="alert">
		  		...
		  		<div class='card'>
				    ...
				    <div>
				    	Numero Voci totali presenti nel sistema: "${impiegato_list_all.size()}"
				    </div>
				    <div>
				    	Numero Voci che verranno modificate in seguito alla procedura: "${impiegato_list_attribute.size()}"
				    </div>
				    <div>
				    	Sei sicuro di volere disabilitare tutti i satelliti attualmente in orbita?
				    </div>
				    <div class='card-body'>
				    	<form method="post" action="${pageContext.request.contextPath}/satellite/disabilita">
				    		
				    		<button type="submit" name="submit" value="submit" id="submit" class="btn btn-danger btn-sm">DISABILITA TUTTI</button>
				    	</form>
