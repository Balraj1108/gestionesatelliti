			  ...
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	...
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Data di dataLancio:</dt>
							  <dd class="col-sm-9"><fmt:formatDate type="date" value = "${show_impiegato_attr.dataLancio}" /></dd>
					    	</dl>
					    	
					    	<dl class="row">
							  <dt class="col-sm-3 text-right">Data di dataRientro:</dt>
					    ...
					    <div class='card-footer'>
					        <a href="${pageContext.request.contextPath}/satillite" class='btn btn-outline-secondary' style='width:80px'>
